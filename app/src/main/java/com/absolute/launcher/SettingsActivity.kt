...
import com.absolute.launcher.settings.SectionsPagerAdapter
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        if (getSavedTheme(this) == "custom") {
            ...
            activity_settings_tabs.setBackgroundColor(dominantColor)
            activity_settings_tabs.setSelectedTabIndicatorColor(vibrantColor)
        }
        else if (getSavedTheme(this)=="dark"){
            activity_settings_tabs.setSelectedTabIndicatorColor(ContextCompat.getColor(this, R.color.finnmglasTheme_text_color))
            activity_settings_tabs.setBackgroundColor(ContextCompat.getColor(this, R.color.darkTheme_background_color))
        }
        else{
            activity_settings_tabs.setSelectedTabIndicatorColor(ContextCompat.getColor(this, R.color.finnmglasTheme_text_color))
        }
